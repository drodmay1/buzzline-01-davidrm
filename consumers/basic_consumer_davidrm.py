...
def process_message(log_file) -> None:
    ...
    with open(log_file, "r") as file:
        ...
        # Keep track of the total number of messages processed
        total_messages = 0
        ...
        while True:
            ...
            # monitor and alert on special conditions (example: "amazing" messages)
            if "amazing" in message:
                print(f"ALERT: Found an amazing! \n{message}")
                logger.warning(f"ALERT: Found and amazing message! \n{message}")
...
def main() -> None:
    ...
    logger.info(f"Reading log file at {log_file_path}.")
